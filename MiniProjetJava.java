...
public class MiniProjetJava {
    ...
    static void afficherBarreChargement(int nbmessages, int multiplieur,int index){
        ...
        System.out.print("║");
        for(int i = 0; i < pas; i++)      System.out.print("█");
        for(int i = pas; i < taille; i++) System.out.print(" ");        
        System.out.println("║");
    ...
    static void calculMoyenneStats(int[] stats){
        ...
        try{stats[14] = stats[31] / stats[2];}catch (ArithmeticException e){}

        try{stats[16] = stats[32] / stats[3];}catch (ArithmeticException e){}
        try{stats[18] = stats[33] / stats[4];}catch (ArithmeticException e){}

        try{stats[20] = stats[34] / stats[6];}catch (ArithmeticException e){}
        try{stats[22] = stats[35] / stats[7];}catch (ArithmeticException e){}
        try{stats[24] = stats[36] / stats[8];}catch (ArithmeticException e){}

        try{stats[26] = stats[37] / stats[10];}catch (ArithmeticException e){}
        try{stats[28] = stats[38] / stats[11];}catch (ArithmeticException e){}
        try{stats[30] = stats[39] / stats[12];}catch (ArithmeticException e){}
    ...
    static void menuPrincipal(String[] listeDeMots,int[] stats, String[] nomstats){
        ...
        do{
            ...
            switch(choixMenu){
                ...
                case 5 -> System.out.println("Vous sortez du jeu");
            }
        }while(choixMenu != 5); /*Cette boucle permet de terminer le programme
    ...
    static void startJeu1(int niveau, String[] listeDeMots, int[] stats) { //Lance le niveau choisi
        ...
        do{
            switch(niveau){
                case 1 -> jeu1Niveau1(listeDeMots, stats); //Lance le niveau 1
                case 2 -> jeu1Niveau2(listeDeMots, stats); //Lance le niveau 2
                case 3 -> jeu1Niveau3(listeDeMots, stats); //Lance le niveau 3
            }
    ...
    static void startJeu2(int niveau, int[] stats) { //Lance le niveau choisi
        ...
        do{
            switch(niveau){
                case 1 -> jeu2Niveau1(stats); //Lance le niveau 1
                case 2 -> jeu2Niveau2(stats); //Lance le niveau 2
                case 3 -> jeu2Niveau3(stats); //Lance le niveau 3
            }
    ...
    static void startJeu3(int niveau, String[] listeDeMots, int[] stats){ //Lance le niveau choisi
        ...
        do{
            switch(niveau){
                case 1 -> jeu3Niveau1(listeDeMots, stats); //Lance le niveau 1
                case 2 -> jeu3Niveau2(listeDeMots, stats); //Lance le niveau 2
                case 3 -> jeu3Niveau3(listeDeMots, stats); //Lance le niveau 3
            }
    ...
    static void corpsJeu3(String[] listeDeMots, int[] stats, int nombreDePaires, int longueurMotMin, int longueurMotMax){
        ...
        for(int i = 0; i < nombreDePaires;  i++){
            ...
            if(i == nombreDePaires-1) isWin = true;
        }
        ...
        if(nombreDePaires == 5){
            stats[37] += score;
            if(stats[25] < score) stats[25] = score;
        }
        if(nombreDePaires == 10){
            stats[38] += score;
            if(stats[27] < score) stats[27] = score;
        }
        if(nombreDePaires == 15){
            stats[39] += score;
            if(stats[29] < score) stats[29] = score;
        }
